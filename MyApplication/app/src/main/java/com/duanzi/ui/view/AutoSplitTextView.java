...
public class AutoSplitTextView extends TextView
{
    ...
    public AutoSplitTextView(Context context, float textSize, int textColor, float paddingLeft, float paddingRight, float marginLeft, float marginRight){
        super(context);
